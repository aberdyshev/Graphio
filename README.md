...
- Вкладки Area analysis и Extrapolation всегда пусты, либо неясно, когда они работают
- Не показан аппроксимирующий полином датасета
- Не работает вычисление производной (в том числе и в точке)
- Visible on Plot отключает не только аппроксимирующий полином, но и точки данных
- 
