...
- **Вкладки Area analysis и Extrapolation всегда пусты, либо неясно, когда они работают** (Раньше работало)
- **Не показан аппроксимирующий полином датасета** (Раньше работало)
- Не работает вычисление производной (в том числе и в точке) НЕ РАБОТАЕТ!
- **Visible on Plot** ()УДАЛИТЬ
- 
